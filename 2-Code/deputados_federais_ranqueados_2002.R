...
final_final_2002 <- final_lista_partidos |>
  group_by(SIGLA_UE,
           NOME_CANDIDATO) |>
...
final_quebras_2002 <- final_final_2002 |>
  group_by(UF,
           NOME_PARTIDO) |>
  mutate(
...
final_copartisans_2002 <- final_quebras_2002 |>
  group_by(UF, 
           IDENTIFICADOR_LEGENDA) |>
...
final_copartisans_2002 <- final_copartisans_2002 |>
  group_by(UF,
           NOME_PARTIDO) |>
...
# Salvando o dado ---------------------------------------------------------
saveRDS(final_copartisans_2002, file = "deputados_federais_ranqueados_2002")
write.csv(final_copartisans_2002, "deputados_federais_ranqueados_2002.csv")
