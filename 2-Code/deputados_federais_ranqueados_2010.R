...
N_cadeiras_partidos <- final_final_2010 %>%
  group_by(UF, 
           NOME_PARTIDO) |>
...
N_cadeiras_coligacao <- final_final_2010 %>%
  group_by(UF, 
           NOME_COLIGACAO) |>
...
# Join
base_final_2010 <- final_final_2010 |>
  left_join(N_cadeiras_coligacao, 
            by = c("UF",
                   "NOME_COLIGACAO"))

# Salvando o dado ---------------------------------------------------------
saveRDS(base_final_2010, file = "deputados_federais_ranqueados_2010")
write.csv(base_final_2010, "deputados_federais_ranqueados_2010.csv")
