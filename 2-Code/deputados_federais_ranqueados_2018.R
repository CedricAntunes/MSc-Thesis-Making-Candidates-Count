...
N_cadeiras_partidos <- final_final_2018 %>%
  group_by(UF, 
           NOME_PARTIDO) |>
...
N_cadeiras_coligacao <- final_final_2018 %>%
  group_by(UF, 
           NOME_COLIGACAO) |>
...
# Join
base_final_2018 <- final_final_2018 |>
  left_join(N_cadeiras_coligacao, 
            by = c("UF",
                   "NOME_COLIGACAO"))

# Salvando o dado ---------------------------------------------------------
saveRDS(base_final_2018, file = "deputados_federais_ranqueados_2018")
write.csv(base_final_2018, "deputados_federais_ranqueados_2018.csv")
